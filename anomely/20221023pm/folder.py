    ...
    def __init__(
        ...
        Args:
            ...
            normal_dir (str, optional): Name of the directory containing normal images.
                Defaults to "normal".
            abnormal_test_dir (str, optional): Name of the directory containing abnormal images.
        ...
        self.abnormal_test_dir = self.root / abnormal_test_dir if abnormal_test_dir else None
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage in (None, "fit"):
            self.train_data = FolderDataset(
                ...
                abnormal_dir=self.abnormal_test_dir,
